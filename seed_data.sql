...
-- ── 1. PROFILES ──────────────────────────────────────────────
INSERT INTO profiles (id, display_name, status, created_at)
VALUES
  ('a1b2c3d4-0001-0000-0000-000000000001','Arjun Mehta',       'active', NOW() - INTERVAL '45 days'),
  ('a1b2c3d4-0002-0000-0000-000000000002','Sarah Kovacs',      'active', NOW() - INTERVAL '40 days'),
  ('a1b2c3d4-0003-0000-0000-000000000003','Kwame Asante',      'active', NOW() - INTERVAL '38 days'),
  ('a1b2c3d4-0004-0000-0000-000000000004','Priya Nair',        'active', NOW() - INTERVAL '35 days'),
  ('a1b2c3d4-0005-0000-0000-000000000005','Marcus Thompson',   'active', NOW() - INTERVAL '32 days'),
  ('a1b2c3d4-0006-0000-0000-000000000006','Fatima Al-Rashid',  'active', NOW() - INTERVAL '28 days'),
  ('a1b2c3d4-0007-0000-0000-000000000007','Lena Vogt',         'active', NOW() - INTERVAL '25 days'),
  ('a1b2c3d4-0008-0000-0000-000000000008','Mei Lin',           'active', NOW() - INTERVAL '20 days'),
  ('a1b2c3d4-0009-0000-0000-000000000009','Ravi Shankar',      'active', NOW() - INTERVAL '18 days'),
  ('a1b2c3d4-0010-0000-0000-000000000010','Ananya Krishnan',   'active', NOW() - INTERVAL '14 days')
ON CONFLICT (id) DO UPDATE SET display_name = EXCLUDED.display_name;

-- ── 2. PROFILE ROLES ─────────────────────────────────────────
INSERT INTO profile_roles (
  user_id, role, seeker_tier, answerer_tier,
  pts_total, seeker_pts, answerer_pts, cds_last, expertise_tags, created_at
) VALUES
  ('a1b2c3d4-0001-0000-0000-000000000001','both',    2,3,4200,1800,2400,82,ARRAY['Science','Physics','Teaching'],             NOW()-INTERVAL '45 days'),
  ('a1b2c3d4-0002-0000-0000-000000000002','answerer',1,4,6800,0,   6800,91,ARRAY['Science','Mathematics','Neuroscience'],     NOW()-INTERVAL '40 days'),
  ('a1b2c3d4-0003-0000-0000-000000000003','answerer',1,4,7200,0,   7200,88,ARRAY['History','Economics','Philosophy'],          NOW()-INTERVAL '38 days'),
  ('a1b2c3d4-0004-0000-0000-000000000004','both',    2,2,2800,1200,1600,74,ARRAY['Mathematics','Philosophy','Logic'],          NOW()-INTERVAL '35 days'),
  ('a1b2c3d4-0005-0000-0000-000000000005','answerer',1,3,3900,0,   3900,84,ARRAY['Philosophy','History','Critical Thinking'],  NOW()-INTERVAL '32 days'),
  ('a1b2c3d4-0006-0000-0000-000000000006','both',    3,3,5100,2200,2900,78,ARRAY['Psychology','Economics','Teaching'],         NOW()-INTERVAL '28 days'),
  ('a1b2c3d4-0007-0000-0000-000000000007','seeker',  3,1,1800,1800,0,   0, ARRAY['History','Programming','Teaching'],          NOW()-INTERVAL '25 days'),
  ('a1b2c3d4-0008-0000-0000-000000000008','both',    2,3,4500,1900,2600,79,ARRAY['Programming','Computer Science','Teaching'], NOW()-INTERVAL '20 days'),
  ('a1b2c3d4-0009-0000-0000-000000000009','both',    3,2,3200,1800,1400,71,ARRAY['Teaching','Hindi','Education'],              NOW()-INTERVAL '18 days'),
  ('a1b2c3d4-0010-0000-0000-000000000010','seeker',  2,1,1400,1400,0,   0, ARRAY['Teaching','Tamil','Philosophy of Education'],NOW()-INTERVAL '14 days')
ON CONFLICT (user_id) DO UPDATE SET
  seeker_tier=EXCLUDED.seeker_tier, answerer_tier=EXCLUDED.answerer_tier,
  pts_total=EXCLUDED.pts_total, cds_last=EXCLUDED.cds_last;
...
Then three things broke it simultaneously.

First, the army became too expensive. To pay soldiers, emperors debased the currency — put less silver in the coins. Prices went up. People trusted the government less.
...
Third — and most importantly — people stopped believing Rome was worth defending. When Germanic tribes arrived, many Roman citizens did not fight. They watched. Some even helped. The idea of Rome had stopped meaning anything to the people supposed to uphold it.
...
Two explanations: one — your flatmate ate them. Two — a sophisticated biscuit thief broke in, stole only the biscuits, left no other trace, and locked the door perfectly on the way out.
...
-- Motivation vs Discipline — Kwame
...
-- Motivation vs Discipline — Fatima
...
That is the goal: design your environment so that the disciplined behaviour becomes the path of least resistance. Not willpower. Architecture. Put your running shoes next to your bed. Block distractions during work hours. Make the hard thing easy to start.',
