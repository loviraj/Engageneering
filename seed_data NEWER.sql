-- ══════════════════════════════════════════════════════════════
-- ENGAGENEERING™ — Seed Data v1.2
-- Questions and Answers only — no fake profiles needed
-- Asker/answerer_id set to NULL (anonymous community content)
...
-- ── QUESTIONS ────────────────────────────────────────────────
-- asker_id is NULL — cards show "Community" as the asker name
-- This is safe and bypasses the auth.users FK constraint
...
('b0000000-0001-0000-0000-000000000001', NULL,
 'How do you explain entropy to a 12-year-old without using the word disorder?',
 'video', ARRAY['Science','Physics','Teaching'],
 94, 'approved', 'published', 'en', 'English', 312, 2, 50,
 NOW()-INTERVAL '40 days', NOW()-INTERVAL '40 days'),

('b0000000-0002-0000-0000-000000000002', NULL,
 'Why did the Roman Empire fall — explained to someone who thinks history is boring?',
 'video', ARRAY['History','Ancient Rome','Storytelling'],
 89, 'approved', 'published', 'en', 'English', 287, 1, 30,
 NOW()-INTERVAL '35 days', NOW()-INTERVAL '35 days'),

('b0000000-0003-0000-0000-000000000003', NULL,
 'Why does 0.999… equal exactly 1 — and how do you convince a sceptic without using algebra?',
 'video', ARRAY['Mathematics','Logic','Critical Thinking'],
 91, 'approved', 'published', 'en', 'English', 445, 1, 40,
 NOW()-INTERVAL '30 days', NOW()-INTERVAL '30 days'),

('b0000000-0004-0000-0000-000000000004', NULL,
 'Can you explain Occam''s Razor using one concrete example from everyday decision-making?',
 'video', ARRAY['Philosophy','Critical Thinking','Logic'],
 87, 'approved', 'published', 'en', 'English', 198, 1, 0,
 NOW()-INTERVAL '26 days', NOW()-INTERVAL '26 days'),

('b0000000-0005-0000-0000-000000000005', NULL,
 'What is the real difference between motivation and discipline — and which one should we actually be building?',
 'video', ARRAY['Psychology','Self-Improvement','Education'],
 92, 'approved', 'published', 'en', 'English', 523, 2, 60,
 NOW()-INTERVAL '22 days', NOW()-INTERVAL '22 days'),

('b0000000-0006-0000-0000-000000000006', NULL,
 'कक्षा में जिज्ञासा कैसे जगाएं जब छात्र बिल्कुल रुचि नहीं दिखाते?',
 'video', ARRAY['Teaching','Curiosity','Education'],
 86, 'approved', 'published', 'hi', 'Hindi', 234, 1, 35,
 NOW()-INTERVAL '18 days', NOW()-INTERVAL '18 days'),

('b0000000-0007-0000-0000-000000000007', NULL,
 'Why does inflation hurt the poor more than the rich — even when prices rise equally for everyone?',
 'video', ARRAY['Economics','Social Justice','Finance'],
 90, 'approved', 'published', 'en', 'English', 367, 1, 45,
 NOW()-INTERVAL '15 days', NOW()-INTERVAL '15 days'),

('b0000000-0008-0000-0000-000000000008', NULL,
 'How would you explain recursion to someone who has never written a single line of code?',
 'video', ARRAY['Programming','Computer Science','Teaching'],
 88, 'approved', 'published', 'en', 'English', 289, 1, 25,
 NOW()-INTERVAL '12 days', NOW()-INTERVAL '12 days'),

('b0000000-0009-0000-0000-000000000009', NULL,
 'ஒரு மாணவன் கேட்கும் கேள்வி எப்படி ஆசிரியரையே மாற்றிவிடுகிறது?',
 'video', ARRAY['Teaching','Tamil','Philosophy of Education'],
 85, 'approved', 'published', 'ta', 'Tamil', 178, 1, 20,
 NOW()-INTERVAL '9 days', NOW()-INTERVAL '9 days'),

('b0000000-0010-0000-0000-000000000010', NULL,
 'Why do we remember embarrassing moments far more vividly than our greatest achievements?',
 'video', ARRAY['Neuroscience','Psychology','Memory'],
 93, 'approved', 'published', 'en', 'English', 412, 2, 55,
 NOW()-INTERVAL '6 days', NOW()-INTERVAL '6 days')

ON CONFLICT (id) DO NOTHING;

-- ── ANSWERS ──────────────────────────────────────────────────
-- answerer_id is NULL — safe, bypasses auth FK constraint
...
'video','en','English', 88,92,85,90,95, 90,92,91, TRUE,'published',
NOW()-INTERVAL '39 days', NOW()-INTERVAL '39 days'),

-- Roman Empire — Kwame Asante
('b0000000-0002-0000-0000-000000000002', NULL,
...
'video','en','English', 91,94,88,96,90, 92,94,93, TRUE,'published',
NOW()-INTERVAL '34 days', NOW()-INTERVAL '34 days'),

-- 0.999 = 1 — Sarah Kovacs
('b0000000-0003-0000-0000-000000000003', NULL,
...
'video','en','English', 89,93,86,92,97, 91,90,91, TRUE,'published',
NOW()-INTERVAL '29 days', NOW()-INTERVAL '29 days'),

-- Occam Razor — Marcus Thompson
('b0000000-0004-0000-0000-000000000004', NULL,
...
'video','en','English', 87,90,89,88,94, 89,88,89, TRUE,'published',
NOW()-INTERVAL '25 days', NOW()-INTERVAL '25 days'),

-- Motivation vs Discipline — Kwame Asante
('b0000000-0005-0000-0000-000000000005', NULL,
...
'video','en','English', 93,91,95,89,92, 92,95,93, TRUE,'published',
NOW()-INTERVAL '21 days', NOW()-INTERVAL '21 days'),

-- Motivation vs Discipline — Fatima Al-Rashid
('b0000000-0005-0000-0000-000000000005', NULL,
...
'video','en','English', 88,86,90,84,91, 88,86,87, TRUE,'published',
NOW()-INTERVAL '20 days', NOW()-INTERVAL '20 days'),

-- Hindi Teaching — Ravi Shankar
('b0000000-0006-0000-0000-000000000006', NULL,
...
'video','hi','Hindi', 85,88,84,86,90, 87,88,87, TRUE,'published',
NOW()-INTERVAL '17 days', NOW()-INTERVAL '17 days'),

-- Inflation — Kwame Asante
('b0000000-0007-0000-0000-000000000007', NULL,
...
'video','en','English', 92,90,94,87,96, 92,93,92, TRUE,'published',
...
'video','en','English', 90,94,88,95,92, 92,91,91, TRUE,'published',
NOW()-INTERVAL '11 days', NOW()-INTERVAL '11 days'),

-- Tamil Teaching — Ananya Krishnan
('b0000000-0009-0000-0000-000000000009', NULL,
...
'video','ta','Tamil', 84,87,82,88,88, 86,85,86, TRUE,'published',
...
'video','en','English', 94,96,90,93,97, 94,96,95, TRUE,'published',
NOW()-INTERVAL '5 days', NOW()-INTERVAL '5 days'),

-- Memory — Fatima Al-Rashid
('b0000000-0010-0000-0000-000000000010', NULL,
...
'video','en','English', 88,91,86,90,94, 90,88,89, TRUE,'published',
